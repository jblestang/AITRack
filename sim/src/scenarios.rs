...
impl Scenario {
    ...
    fn simple(seed: u64) -> Self {
        let targets = vec![
            target(0, [-20000., 0., 0.], [150., 0., 0.], MotionSpec::ConstantVelocity, None, None),
            target(1, [0., -20000., 0.], [0., 150., 0.], MotionSpec::ConstantVelocity, None, None),
            target(2, [10000., 10000., 0.], [-80., -80., 0.], MotionSpec::ConstantVelocity, None, None),
            target(3, [-5000., 15000., 0.], [100., -50., 0.], MotionSpec::ConstantTurn { omega: 0.01 }, None, None),
            target(4, [15000., -5000., 0.], [-50., 120., 0.], MotionSpec::ConstantVelocity, None, None),
        ];

        let radars = vec![
            sim_radar(0, [-10000., -10000., 0.], 1.0, 0.9, 2.0, 200., 0.04, InjectedBias::default()),
            sim_radar(1, [10000., 10000., 0.], 0.5, 0.85, 2.0, 250., 0.05, InjectedBias::default()),
        ];
    ...
    fn dense_crossing(seed: u64) -> Self {
        ...
        let radars = vec![
            sim_radar(0, [0., 0., 0.], 1.0, 0.85, 5.0, 250., 0.05, InjectedBias::default()),
            sim_radar(1, [-15000., 0., 0.], 0.5, 0.80, 5.0, 300., 0.06, InjectedBias::default()),
            sim_radar(2, [15000., 0., 0.], 0.75, 0.88, 5.0, 200., 0.04, InjectedBias::default()),
        ];
        ...
        let targets = (0..500)
            .map(|i| {
                ...
                let motion = if rng.gen::<f64>() < 0.3 {
                    MotionSpec::ConstantTurn { omega: (rng.gen::<f64>() - 0.5) * 0.05 }
                } else {
                    MotionSpec::ConstantVelocity
                };
    ...
    fn bias_calibration(seed: u64) -> Self {
        ...
        let radars = vec![
            sim_radar(0, [-5000., 0., 0.], 1.0, 0.9, 2.0, 200., 0.04,
                InjectedBias { dx: 200.0, dy: -150.0, dtheta: 0.02, dt0: 0.3 }),
            sim_radar(1, [5000., 0., 0.], 1.0, 0.9, 2.0, 200., 0.04,
                InjectedBias { dx: -100.0, dy: 80.0, dtheta: -0.015, dt0: -0.2 }),
        ];
    ...
    fn fighter(seed: u64) -> Self {
        ...
        let targets = vec![
            ...
            Target {
                ...
                appear_at: None, disappear_at: None,
            },
            Target {
                id: 1,
            ...
            Target {
                ...
                motion: seg(vec![
                    ...
                    (22.0, MotionSpec::ConstantAccel { ax: 5., ay: -3., az: 0. }),
                    (30.0, MotionSpec::ConstantVelocity),
            ...
            Target {
                ...
                motion: seg(vec![
                    ...
                    (28.0, MotionSpec::ConstantAccel { ax: -4., ay: 6., az: 0. }),
        ...
        let radars = vec![
            sim_radar(0, [-5000., 0., 0.], 2.0, 0.92, 3.0, 150., 0.03,
                InjectedBias::default()),
            sim_radar(1, [5000., 0., 0.], 2.0, 0.90, 3.0, 150., 0.03,
                InjectedBias::default()),
            sim_radar(2, [0., 8000., 0.], 1.0, 0.88, 2.0, 200., 0.04,
                InjectedBias::default()),
        ];
        ...
        let targets = (0..1000)
            .map(|i| {
                ...
                let motion = match rng.gen_range(0u8..4) {
                    0 => MotionSpec::ConstantTurn { omega: (rng.gen::<f64>() - 0.5) * 0.06 },
